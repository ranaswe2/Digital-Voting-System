...
public class CandidateList extends javax.swing.JFrame implements AppInfo{

                String cata1,cata2,cata3,cata4,cata5;
                int candidateNum1, candidateNum2, candidateNum3, candidateNum4, candidateNum5;
                String path;
   
    public CandidateList() throws Exception {
        super(" "+version);
        initComponents();
        ...
        this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
             ...
             jLabel1.setText(CommissionLogin.ename);
             
    VoteQuery.basicQuery("SELECT * FROM `election` WHERE `e_code`='"+CommissionLogin.ecode+"'");
   ...
   //************************************************************************************************************//         
            ...
            String query= "SELECT * FROM `candidate` as c, `voter` as v WHERE c.secrete ='"+CommissionLogin.ecode+"' and v.secrete ='"+CommissionLogin.ecode+"' and c.voterId=v.voterId and c.designation='"+cata1+"' ";
  ...
  //************************************************************************************************************//         
            ...
            if(candidateNum3  !=0){
            String query= "SELECT * FROM `candidate` as c, `voter` as v WHERE c.secrete ='"+CommissionLogin.ecode+"' and v.secrete ='"+CommissionLogin.ecode+"' and c.voterId=v.voterId and c.designation='"+cata3+"' ";
            ResultSet rs= st.executeQuery(query);
...
//************************************************************************************************************//         
            ...
            String query= "SELECT * FROM `candidate` as c, `voter` as v WHERE c.secrete ='"+CommissionLogin.ecode+"' and v.secrete ='"+CommissionLogin.ecode+"' and c.voterId=v.voterId and c.designation='"+cata2+"' ";
            ResultSet rs= st.executeQuery(query);
   ...
   //************************************************************************************************************//         
            ...
            String query= "SELECT * FROM `candidate` as c, `voter` as v WHERE c.secrete ='"+CommissionLogin.ecode+"' and v.secrete ='"+CommissionLogin.ecode+"' and c.voterId=v.voterId and c.designation='"+cata4+"' ";
            ResultSet rs= st.executeQuery(query);
...
//************************************************************************************************************//         
            ...
            String query= "SELECT * FROM `candidate` as c, `voter` as v WHERE c.secrete ='"+CommissionLogin.ecode+"' and v.secrete ='"+CommissionLogin.ecode+"' and c.voterId=v.voterId and c.designation='"+cata5+"' ";
            ResultSet rs= st.executeQuery(query);
   ...
   //-------------------------------------------------------------------------------------------------------------//             
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Candidates of ");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(820, 10, 220, 30);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(10, 110, 590, 530);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vote_booth/logo.png"))); // NOI18N
        jPanel1.add(jLabel4);
        jLabel4.setBounds(1340, 100, 540, 530);

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 1884, Short.MAX_VALUE)
        );
